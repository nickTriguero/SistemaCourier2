                ...
                <div class="col-lg-9">
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-4 col-md-6"><h5><strong>Lugar de Origen:</strong></h5><p class="fs-4"><%= rs.getString("inicio")%></p></div>
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-lg-6 col-md-6"><h5><strong>Fecha de creación:</strong></h5><p class="fs-4"><%= sdf.format(rs.getTimestamp("fecha_creacion"))%></p></div>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="progress" style="height: 50px;">
                                    <div class="progress-bar bg-<%= color%> progress-bar-striped progress-bar-animated d-flex align-items-center justify-content-center"
                                         style="width: <%= "Entregado".equals(estado) ? 100 : "En camino".equals(estado) ? 70 : 35%>%;">
                            ...
                            %>
                            <!--No encontrado o Número de guía equivocado-->
                            <div class="text-center py-5">
                                <h1 class="display-3 fw-bold">Envío no encontrada</h1>
                                <p class="lead fs-3">El envió con el número de guía <span class="text fw-bold"><%= guia%></span> no existe en nuestro sistema.</p>
